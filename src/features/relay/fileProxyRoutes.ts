...
import {
  claimRelayFileToken,
  finalizeRelayFileToken,
  releaseRelayFileToken,
} from "../../data/relayTokens.js";
...
export const registerRelayFileProxyRoutes = (payload: {
  receiver: { app: express.Application };
  installationStore: InstallationStore;
}) => {
  const { receiver, installationStore } = payload;
