...
export type GetAllConnectorsArgs = FunctionArgs<
  typeof api.portal.connectors.getAllConnectors
>;
export type GetAllConnectorsResult = FunctionReturnType<
  typeof api.portal.connectors.getAllConnectors
>;
export type PortalConnector = GetAllConnectorsResult[number];
export type ConnectorStatus = PortalConnector["status"];

export type UpsertConnectorArgs = FunctionArgs<
  typeof api.portal.connectors.upsertConnector
>;
export type UpsertConnectorResult = FunctionReturnType<
  typeof api.portal.connectors.upsertConnector
>;
...
export type GetBillingResult = FunctionReturnType<
  typeof api.portal.billing.getBilling
>;
